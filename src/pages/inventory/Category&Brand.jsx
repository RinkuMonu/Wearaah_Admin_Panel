...
export default function CategorySection() {
    ...
    const currentProducts = categories.slice(indexOfFirstRow, indexOfLastRow);
                        ...
                        <div className="bg-white w-full max-w-lg rounded-lg shadow-lg p-6 relative">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select className="w-full border rounded-md px-3 py-2 text-sm" placeholder="Select department">
                                        <option>Men</option>
                                        <option>Women</option>
                                        <option>Kids</option>
                                    </select>
                            ...
                            <div className="flex justify-end gap-3 mt-6">
                                ...
                                <button
                                    className="px-4 py-2 bg-[#927f68] text-white rounded-md text-sm"
                                >
                                    Save
                                </button>
                            </div>
