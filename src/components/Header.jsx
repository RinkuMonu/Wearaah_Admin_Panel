...
import { UserRound, LogOut, KeyRound, User } from "lucide-react";
            ...
            <div className="bg-white w-[420px] rounded-xl shadow-xl p-6 relative">
              ...
              <div className="flex mb-4 ">
                <button
                  ...
                  className={`flex-1 py-2 ${activeTab === "forgot"
                      ? "border-b-2 border-[#927f68]"
                      : ""
                    }`}
                >
                  Forget Password
                ...
                <button
                  ...
                  className={`flex-1 py-2 ${activeTab === "modify"
                      ? "border-b-2 border-[#927f68]"
                      : ""
                    }`}
                >
